...
import com.axonivy.utils.gdprconnector.exception.RicohException;
...
public final class FacesContexts {
	...
	public static <E> E evaluateValueExpression(String valueExpressionLiteal, Class<E> returnedType) {
		...
		try {
			...
			throw new RicohException("Cannot invoke value expression", e);
		} catch (ClassCastException ex) {
			throw new RicohException("The data type of return value is not as expected", ex);
		}
	}
	...
	private static <E> E invokeMethod(ELContext elContext, MethodExpression methodExpression, Object[] parameters,
		...
		try {
			...
			throw new RicohException("Cannot invoke method expression", e);
		} catch (ClassCastException ex) {
			throw new RicohException("The data type of return value is not as expected", ex);
		}
	}
	...
	public static void redirect(String url) {
		try {
			...
			throw new RicohException(error, e);
		}
	}
