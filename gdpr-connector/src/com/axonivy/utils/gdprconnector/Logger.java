package com.axonivy.utils.gdprconnector;
			...
			synchronized (Logger.class) {
				if (!initialized) {
					try {
						...
						LOG.error(
								"Could not determine, whether this Logger will be used in Designer or not, assuming it is not.");
					} finally {
						initialized = true;
					}
					LOG.info("Logging was initialized, using the " + (ivyLogger != null ? "Ivy" : "general")
							+ " Logger.");
				}
			}
		}
