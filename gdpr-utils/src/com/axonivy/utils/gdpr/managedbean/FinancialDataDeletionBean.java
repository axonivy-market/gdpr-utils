...
import com.axonivy.utils.gdpr.utils.IvyUtils;
...
public class FinancialDataDeletionBean  extends AbstractDataDeletionBean implements Serializable {
	...
	private String getTranslateStringFromCms(String message, Object... params) {
		return Ivy.cms().co(message, Arrays.asList(params));
	}
